...
MODELS = {
    ...
    "qwen3.8-orca-fp8": "qwen3.8-orca-fp8", "qwen3.8-orca": "qwen3.8-orca-fp8",
    "qwen3.8-27b-uncensored": "qwen3.8-orca-fp8", "orcarouter-qwen3.8": "qwen3.8-orca-fp8",
    "orcarouter/qwen3.8-27b-uncensored-fp8": "qwen3.8-orca-fp8",

}

VALID_MODELS = {"gpt-oss", "leanstral", "leanstral-1.5", "nemotron-3-super", "qwen3.8-orca-fp8", "gemma-4"}
...
MODEL_INFO = [
    ...
    {"id": "qwen3.8-orca-fp8", "object": "model", "canonical": "qwen3.8-orca-fp8"},
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print(f"Models: gpt-oss-120b, leanstral-1.5-119b-a6b, leanstral-2603, nemotron-3-super, qwen3.8-orca-fp8, gemma-4")
