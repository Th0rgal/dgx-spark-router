...
VALID_MODELS = {"gpt-oss", "leanstral", "leanstral-1.5", "nemotron-3-super", "qwen3.8-aeon-bf16", "gemma-4"}
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print(f"Models: gpt-oss-120b, leanstral-1.5-119b-a6b, leanstral-2603, nemotron-3-super, qwen3.8-aeon-bf16, gemma-4")
    print(f"Aliases: scientific, writing, leanstral, lean4, proving, reasoning, thinking, qwen3.8-aeon, aeon-ultimate, gemma")
